...
def get_arguments(parser):
    ...
    parser.add_argument(
        '--decoding_depth', type=int, default=1, help='Depth of decoding network in the decoder. (default: 1)'
    )
    parser.add_argument(
        '--fourier_frequency', type=int, default=8, help='Fourier feature frequency. (default: 8)'
    )
    parser.add_argument(
        '--aug_ratio', type=float, default=0.3, help='Probability to randomly crop. (default: 0.3)'
    )
    # ===================================
    # for dataset
    parser.add_argument(
