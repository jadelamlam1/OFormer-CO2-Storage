...
print(torch.max(test_u))
print(torch.min(test_u))
# %%
...
checkpoint_path = '/home/kint/Music/ufno/logs/model_ckpt/model_checkpoint_epoch_140.ckpt'
...
for i, (x, y) in enumerate(test_loader):
    ...
    mre = compute_mre(y_t, y_p) / (test_a.shape[0] * 24 * thickness * 200)
...
for i, (x, y) in enumerate(test_loader):
    ...
    if i >= 10:  # Limit to first 10 samples for quick checking
        break
